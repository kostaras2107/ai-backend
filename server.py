...
def handle_travel(data, client):
    ...
    • 🏨 Θέλεις να σου βρω ξενοδοχείο;
    • ✨ Θέλεις να σου προτείνω εγώ 
            έναν προορισμό;
...
- Αν βρήκες προϊόντα εντός budget → πες ΜΟΝΟ:
  "Βρήκα προϊόντα που είναι εντός του budget σου και έχουν καλές κριτικές 👌 Αν θες να στα δείξω γράψε 'ναι', αλλιώς μπορούμε να ψάξουμε κάτι άλλο 😊"
